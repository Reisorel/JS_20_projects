...
async function fetchData(){
  try {
    ...
    const response = await fetch(`https://api.unsplash.com/search/photos?page=${pageIndex}&per_page=30&query=${searchQuery}&client_id=NuhdfOMg_Wt9PhVbtbn2Dg9mp9bAQk9DCNZiqk0YlU4`)
